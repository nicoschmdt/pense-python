...
Repetindo o meu conselho do capítulo anterior, sempre que você aprender um recurso novo, você deve testá-lo no [modo interativo](09-glossario.md#modo-interativo) e fazer erros de propósito para ver o que acontece.

* Vimos que n = 42 é legal. E 42 = n?

* Ou x = y = 1?

* Em algumas linguagens, cada [instrução](09-glossario.md#instrução) termina em um ponto e vírgula ;. O que acontece se você puser um ponto e vírgula no fim de uma instrução no Python?
