...
n%2 == 0 or n%3 == 0 é verdadeiro se uma ou as duas [condição](13-glossario.md#condição)(ões) for(em) verdadeira(s), isto é, se o número for divisível por 2 ou 3.

Finalmente, o operador not nega uma [expressão booleana](13-glossario.md#expressão-booleana), então not (x &gt; y) é verdade se x &gt; y for falso, isto é, se x for menor que ou igual a y.
